...
local pktSize		= 64; -- 128, 256, 512, 1024, 1280, 1518 };
local sendport		= "0";
local recvport		= "1";
local protocol		= "udp";
...
pktgen.set_proto(sendport..","..recvport, protocol);
...
local function doSearch(minRate, maxRate)
	local diff, midRate;
